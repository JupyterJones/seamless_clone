...
# -------------------- Upload Route --------------------
@app.route("/clone_upload", methods=["GET", "POST"])
def clone_upload():
    if request.method == "POST":
        ...
        return render_template("clone_index.html", bg_path=bg_path, obj_path=obj_path)

    return render_template("clone_index.html", bg_path=None, obj_path=None)
